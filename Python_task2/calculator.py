...
#Simple calculator in python. For the GUI i have use tkinter
...
label = Label(window, textvariable=equation_label, font=('consolas', 20), bg="darkgrey", fg="black", width=29, height=2)
label.pack()
...
plus = Button(frame, text='+', height=4, width=9, font=35, bg="black", fg="white", command=lambda: button_press('+'))
plus.grid(row=0, column=3)

minus = Button(frame, text='-', height=4, width=9, font=35, bg="black", fg="white", command=lambda: button_press('-'))
minus.grid(row=1, column=3)

multiply = Button(frame, text='*', height=4, width=9, font=35, bg="black", fg="white", command=lambda: button_press('*'))
multiply.grid(row=2, column=3)

divide = Button(frame, text='/', height=4, width=9, font=35, bg="black", fg="white", command=lambda: button_press('/'))
divide.grid(row=3, column=3)

equal = Button(frame, text='=', height=4, width=9, font=35, bg="black", fg="white", command=equals)
equal.grid(row=3, column=2)

decimal = Button(frame, text='.', height=4, width=9, font=35, bg="black", fg="white", command=lambda: button_press('.'))
decimal.grid(row=3, column=1)

clear = Button(window, text='clear', height=4, width=20, font=35, bg="black", fg="orange", command=clear)
clear.pack()
